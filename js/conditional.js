...
switch(color) {
    ...
    case "blue":
        ...
        break;
    case "cyan":
        console.log("I don't know anything about you");
        break;
    default:
        console.log("I don't Know what " + color + " is.");
}
...
var colorInput = prompt("Choose a color.")
...
alert("Your bill after the discount is $" + totalAfterDiscount.toFixed(2));
